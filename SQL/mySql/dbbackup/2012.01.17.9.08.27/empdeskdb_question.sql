...
CREATE TABLE `question` (
  ...
  `reviewerquestion` tinyint(1) DEFAULT NULL,
  `elementoption` varchar(100) DEFAULT NULL,
  `elementlabel` varchar(100) DEFAULT NULL,
  `elementtype` varchar(25) DEFAULT NULL,
  `ratingstype` varchar(25) DEFAULT NULL,
  `ratingscale` int(11) DEFAULT NULL,
